...
PACMAN_PACKAGES="neovim nodejs npm fwupd cachyos-gaming-meta appmenu-gtk-module libdbusmenu-glib wget unzip libvoikko hspell nuspell hunspell aspell gnome-shell-extension-dash-to-dock neofetch"
